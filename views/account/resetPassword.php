...
echo $form->field($model, 'retry_password')
    ->textInput(['id' => 'retry_password', 'style' => 'width: 50%; margin-left: 10px;', 'class' => 'input-group input-group-lg society-form-input'])
    ->label('Повтор пароля *', ['style' => "margin-left: 10px;"]);
